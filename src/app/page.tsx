...
export default async function HomePage() {
  ...
  if (error) {
    return <div className="p-10 text-red-500">Error al cargar datos.</div>;
  }

  return (
    <main className="max-w-5xl mx-auto p-8">
      <h1 className="text-4xl font-bold mb-6">Mi Catálogo de Proyectos</h1>
      <p className="text-gray-600 mb-8">Selecciona un elemento para ver sus detalles en una ruta dinámica.</p>
